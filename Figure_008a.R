...
theoretical_density <- function(t, T, a, grid_n = 200) {
...
density_data <- do.call(rbind, lapply(t_vals, theoretical_density, T = T_total, a = a))
...
ggsave(
  filename = "Figures/Figure_008a.png",
  plot = p,
  width = 8,
  height = 4,
  units = "in",
